...
const Banner = () => {
    return (
        <div className='w-full min-h-[70dvh] max-w-6xl mx-auto bg-[#f3f3f3] grid grid-cols-1 md:grid-cols-2 place-items-center p-10 px-20 rounded-2xl border border-[#c7b8b8]'>
